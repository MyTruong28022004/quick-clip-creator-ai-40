      ...
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <Link to="/create" className={`flex items-center gap-2 text-sm font-extrabold tracking-widest uppercase font-sans hover:text-creative-500 transition-colors ${theme === "light" ? "text-gray-800" : ""}`}>
